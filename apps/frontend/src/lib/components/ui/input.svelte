...
const baseStyles = "block w-full bg-transparent border-b px-3 py-2 min-h-[44px] text-ink-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink-900 focus-visible:ring-offset-1 placeholder-ink-400/50 transition-colors duration-200 text-[16px] md:text-lg font-serif touch-action-manipulation";
